...
export function HoverBar({ portalData }) {
    ...
    const { setSlidingSidebarOpen, setSectionId, setContentType } =
        useSlidingSidebar();
                    ...
                    <DockIcon size={48} className="w-480 mx-14">
                        <Tooltip>
                            <TooltipTrigger asChild className="w-96">
                                <Link
                                    href={`/dashboard/portal/${portalData.portal.id}?createLink=true`}
                                >
                                    <ShinyButton className="rounded-sm bg-indigo-500 text-sm text-white hover:bg-indigo-600">
                                        Share my Portal
                                    </ShinyButton>
                                </Link>
                            </TooltipTrigger>

...
const ReviewCard = ({ icon, actionIcon, name }: { icon: JSX.Element; actionIcon: JSX.Element; name: string }) => {
  return (
    <div
      className={cn(
        "relative flex items-center justify-between h-16 w-full max-w-sm p-4",
    ...
    >
      ...
      <div className="flex items-center gap-4">
        {icon}
        <div className="h-4 w-40 bg-gray-200 rounded dark:bg-gray-500"></div>
      </div>
      {actionIcon}
    </div>
    </div>
